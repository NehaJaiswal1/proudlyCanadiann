...
import t1 from '../../images/template/temp1.jpg';
      ...
      <Dialog open={popupOpen} onClose={handlePopupClose} >
        <DialogContent>
          {selectedImage ? (
            ...
            <div className='flex'>
              <img src={t1} alt="Template 1" onClick={() => handleImageClick(t1)} style={{ cursor: 'pointer', width: '70px', marginRight: '20px'  }} />
              <img src={t2} alt="Template 2" onClick={() => handleImageClick(t2)} style={{ cursor: 'pointer', width: '70px', marginRight: '20px'  }} />
              <img src={t3} alt="Template 3" onClick={() => handleImageClick(t3)} style={{ cursor: 'pointer', width: '70px' }} />
            </div>
          )}
        </DialogContent>
        <DialogActions>
